...
// CUSTOMER: rate barber and barbershop (combined)
router.post('/rate-barbershop', authenticateCustomer, async (req, res) => {
  try {
    ...
    await pool.query(
      `INSERT INTO notifications (recipient_type, recipient_id, title, message, type, related_id) VALUES ('barbershop',$1,'New Review','A customer left a review for your shop.','review',$2)`,
